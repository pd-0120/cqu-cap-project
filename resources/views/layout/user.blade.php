<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        ...
        <small class="text-muted font-size-sm ml-2">{{ $authUser->role }}</small></h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ $authUser->full_name }}</a>
                <div class="text-muted mt-1">{{ $authUser->role }}</div>
                <div class="navi mt-1">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary">{{ $authUser->email }}</span>
                        </span>
                    </a>
                </div>
            </div>
